...
public class Segment extends Forme {
    ...
    public boolean equals(Object o) {
        ...
        return this.a.getPositionAbsolue().equals(segment.a.getPositionAbsolue()) && this.b.getPositionAbsolue().equals(
                segment.b.getPositionAbsolue());
    }
    ...
    List<Point2D> intersecte(Cercle c) throws NoIntersectionException {
        ...
        double beta = 2 * (dx * (this.a.getPositionAbsolue().getX() - xc) + dy * (this.a.getPositionAbsolue()
                                                                                          .getY() - yc));
        double gamma = Math.pow(this.a.getPositionAbsolue().getX() - xc, 2) + Math.pow(this.a.getPositionAbsolue()
                                                                                               .getY() - yc,
                                                                                       2) - Math.pow(c.rayon, 2);
        ...
        if (delta == 0) { // le segment et est tangent au cercle
            ...
            if (t1 >= 0 && t1 <= 1) {
                liste.add(new Point2D(this.a.getPositionAbsolue()
                                              .addition(this.a.getPositionRelative(this.b).produit(t1))));
            }
            if (t2 >= 0 && t2 <= 1) {
                liste.add(new Point2D(this.a.getPositionAbsolue()
                                              .addition(this.a.getPositionRelative(this.b).produit(t2))));
            }
            if (liste.size() == 0) {
