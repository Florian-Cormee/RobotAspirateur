...
public class ArcDeCercle extends Cercle {
    ...
    /**
     * Crée un arc de cercle à partir de son centre (Point2D), son diametre, et
     * les 2 angles par rapport à l'axe des abscisses x, définissant son
     * ouverture et son orientation.
     * 
     * @param p  Centre
     * @param d  Diametre
     * @param a1 1er angle
    ...
    /**
     * Crée un arc de cecle à partir des coordonnées de son centre, son
     * diametre, et les 2 angles par rapport à l'axe des abscisses, définissant
     * son ouverture et son orientatioon.
     * 
	...
	return Objects.equals(centre, arcDeCercle.centre)
		&& (rayon == arcDeCercle.rayon) && (ang1 == arcDeCercle.ang1)
    ...
    /**
     * Obtient la liste de points d'intersection entre l'instance d'arc de
     * cercle et un polygone mis en argument.
     * 
	...
	if (liste.size() == 0) {
	    throw new NoIntersectionException(this,
		    "Pas d'intersection entre cet arc de cercle et le polygone.");
	} else {
	    return liste;
	}
    }
    ...
    /**
     * Obtient la liste de points d'intersection entre l'instance d'arc de
     * cercle et un rectangle mis en argument.
     * 
	...
	try {
	    ...
	    throw new NoIntersectionException(this,
		    "Pas d'intersection entre cet arc de cercle et le rectangle.");
	}
    }

    /**
     * Obtient la liste de points d'intersection entre l'instance d'arc de
     * cercle et un arc de cercle mis en argument.
     * 
	...
	try {
	    List<Point2D> liste = new Cercle(adc.centre, adc.rayon)
		    .intersecte(this);
