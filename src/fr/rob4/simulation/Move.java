...
class Move extends JPanel {
    ...
    /**
     * Fonction appelee automatiquement quand le JPanel est (re)dessine a
     * l'ecran
     */
	...
	while (true) {
	    ...
	    if (x == 0 || x == 100)
		sens = !sens; // Changement de sens quand la coordonnee x
			      // atteint 0 ou 100
	    // attend 0.01 sec
	    try {
		Thread.sleep(10);
	    ...
	    // Redessine la fenetre (appelle automatiquement entre autres
	    // m.paint())
	    m.repaint();
	}
    }
